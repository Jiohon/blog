...
const Home: React.FC<PageProps<allMdxNodesQuery<"latest" | "Highlights"> & MdxNodesQuery>> = ({
  ...
  return (
    <Space className={styles.home} direction="vertical" size={0}>
      <section className={styles.hero}>
        <span className={styles.eyebrow}>PERSONAL NOTES / 2026</span>
        ...
        <div className={styles.heroMeta}>
          <span>Writing · Making · Learning</span>
